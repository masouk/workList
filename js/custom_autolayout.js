...
readWebData = (function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				$.map(temp,function(val,key){
					var _c = val.close == 1 ? _content_no_link : _content;
					var regex;
					var outline;
	...
	var _content = '<div class="col-md-4 portfolio-item">'+
		...
		'</a>'+
		'<h3>'+
		'<a href="[@URL@]" target="_blank" class="name_tw" rel="nofollow">[@NAME_TW@]</a>'+
		'<a href="[@URL@]" target="_blank" class="name_en" rel="nofollow">[@NAME_EN@]</a>'+
		'</h3>'+
		'<p>'+
		'[@TYPE@]&nbsp;'+
		'[@TYPE@]&nbsp;'+
	...
	var _content_no_link = '<div class="col-md-4 portfolio-item">' +
		...
		'<h3>' +
		'<span href="" class="name_tw" rel="nofollow">[@NAME_TW@]</span>' +
		'<span href="" class="name_en" rel="nofollow">[@NAME_EN@]</span>' +
		'</h3>' +
		'<p>' +
		'[@TYPE@]&nbsp;' +
		'[@TYPE@]&nbsp;' +
